...
public class PlayerMovementController : MonoBehaviour
{
    ...
    private const float MIN_SLIDE_THRESHOLD = 5.5f;
    ...
    public void Movement ( Vector2 inputDirection, bool runInput, bool jumpInput, bool crouchInput, bool proneInput )
    {
        ...
        if ( crouchInput &&  // Crouch input
            ...
            movementVelocity.magnitude >= MIN_SLIDE_THRESHOLD ) // Minimum speed for sliding
        {
        ...
        if ( m_isSliding )
        {
            ...
            if ( m_slideSpeed < MIN_SLIDE_THRESHOLD )
            {
                m_isSliding = false;
            }
        }
