...
public class PlayerManager
{
    ...
    public void SetMovementValues ( int moveInputX, int moveInputY, float moveSpeed, float cameraPitch, bool run, bool crouch, bool jump, bool isGrounded )
    {
        if ( Player == null )
        {
        ...
        Player.SetMovementAnimationValues ( moveInputX, moveInputY, moveSpeed, cameraPitch, run, crouch, jump, isGrounded );
    }
