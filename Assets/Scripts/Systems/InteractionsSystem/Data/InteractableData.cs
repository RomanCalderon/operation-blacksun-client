...
namespace InteractionData
{
    ...
    public struct InteractableData
    {
        ...
        public InteractableData ( string instanceId, int interactionType, bool isInteractable, string interactionContext, Color interactionLabelColor, float interactTime, bool hasAccessKey )
        {
        ...
        public byte [] ToArray ()
        {
            ...
            writer.Write ( InteractionContext );
        ...
        public static InteractableData FromArray ( byte [] bytes )
        {
            ...
            s.InteractionContext = reader.ReadString ();
