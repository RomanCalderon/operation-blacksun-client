...
namespace InteractionData
{
    ...
    public struct InteractableData
    {
        ...
        public InteractableData ( int interactionType, bool isInteractable, string interactionContext, Color interactionLabelColor, float interactTime, bool hasAccessKey )
        {
